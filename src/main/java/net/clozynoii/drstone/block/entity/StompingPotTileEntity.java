...
public class StompingPotTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public StompingPotTileEntity(BlockPos pos, BlockState state) {
		super(DrstoneModBlockEntities.STOMPING_POT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(StompingPotBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<StompingPotTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<StompingPotTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("stomping_pot");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Stomping Pot");
	}
