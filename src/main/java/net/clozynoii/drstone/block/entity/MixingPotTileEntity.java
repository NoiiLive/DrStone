...
public class MixingPotTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MixingPotTileEntity(BlockPos pos, BlockState state) {
		super(DrstoneModBlockEntities.MIXING_POT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(MixingPotBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MixingPotTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MixingPotTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("mixing_pot");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Mixing Pot");
	}
