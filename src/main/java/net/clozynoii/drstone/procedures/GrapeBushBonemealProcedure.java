...
public class GrapeBushBonemealProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, x, y, z, 25, 0.5, 0.5, 0.5, 0);
		...
		if (Math.random() < 0.25) {
			{
				...
				BlockState _bs = DrstoneModBlocks.GRAPE_BUSH_VINE_MATURE.get().defaultBlockState();
