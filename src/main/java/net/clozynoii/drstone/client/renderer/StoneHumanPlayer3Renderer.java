...
import net.clozynoii.drstone.entity.model.StoneHumanPlayer3Model;
...
public class StoneHumanPlayer3Renderer extends GeoEntityRenderer<StoneHumanPlayer3Entity> {
 private static final MinecraftSessionService sessionService = Minecraft.getInstance().getMinecraftSessionService();
    ...
    private final GeoModel<StoneHumanPlayer3Entity> slimModel;
    private final GeoModel<StoneHumanPlayer3Entity> defaultModel;
    private GeoModel<StoneHumanPlayer3Entity> currentModel;

    public StoneHumanPlayer3Renderer(EntityRendererProvider.Context context) {
        super(context, new StoneHumanPlayer3Model());
        this.slimModel = new StoneHumanPlayer3Model();
        this.defaultModel = new StoneHumanPlayer3Model();
        this.currentModel = this.defaultModel;
    }

    @Override
    public ResourceLocation getTextureLocation(StoneHumanPlayer3Entity entity) {
    ...
    @Override
    public void render(StoneHumanPlayer3Entity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        if (entity.isTame() && entity.getOwnerUUID() != null) {
            UUID ownerUUID = entity.getOwnerUUID();
    ...
    private GeoModel<StoneHumanPlayer3Entity> getModel(UUID uuid) {
