...
import net.clozynoii.drstone.entity.model.StoneHumanPlayer4Model;
...
public class StoneHumanPlayer4Renderer extends GeoEntityRenderer<StoneHumanPlayer4Entity> {
 private static final MinecraftSessionService sessionService = Minecraft.getInstance().getMinecraftSessionService();
    ...
    private final GeoModel<StoneHumanPlayer4Entity> slimModel;
    private final GeoModel<StoneHumanPlayer4Entity> defaultModel;
    private GeoModel<StoneHumanPlayer4Entity> currentModel;

    public StoneHumanPlayer4Renderer(EntityRendererProvider.Context context) {
        super(context, new StoneHumanPlayer4Model());
        this.slimModel = new StoneHumanPlayer4Model();
        this.defaultModel = new StoneHumanPlayer4Model();
        this.currentModel = this.defaultModel;
    }

    @Override
    public ResourceLocation getTextureLocation(StoneHumanPlayer4Entity entity) {
    ...
    @Override
    public void render(StoneHumanPlayer4Entity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        if (entity.isTame() && entity.getOwnerUUID() != null) {
            UUID ownerUUID = entity.getOwnerUUID();
    ...
    private GeoModel<StoneHumanPlayer4Entity> getModel(UUID uuid) {
