...
import net.clozynoii.drstone.entity.model.StoneHumanPlayer1Model;
...
public class StoneHumanPlayer1Renderer extends GeoEntityRenderer<StoneHumanPlayer1Entity> {
 private static final MinecraftSessionService sessionService = Minecraft.getInstance().getMinecraftSessionService();
    ...
    private final GeoModel<StoneHumanPlayer1Entity> slimModel;
    private final GeoModel<StoneHumanPlayer1Entity> defaultModel;
    private GeoModel<StoneHumanPlayer1Entity> currentModel;

    public StoneHumanPlayer1Renderer(EntityRendererProvider.Context context) {
        super(context, new StoneHumanPlayer1Model());
        this.slimModel = new StoneHumanPlayer1Model();
        this.defaultModel = new StoneHumanPlayer1Model();
        this.currentModel = this.defaultModel;
    }

    @Override
    public ResourceLocation getTextureLocation(StoneHumanPlayer1Entity entity) {
    ...
    @Override
    public void render(StoneHumanPlayer1Entity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        if (entity.isTame() && entity.getOwnerUUID() != null) {
            UUID ownerUUID = entity.getOwnerUUID();
    ...
    private GeoModel<StoneHumanPlayer1Entity> getModel(UUID uuid) {
