...
public class ModelStoneVillagerBroken<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("drstone", "model_stone_villager_broken"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso = body.addOrReplaceChild("torso",
				CubeListBuilder.create().texOffs(16, 20).addBox(-4.0F, -7.5F, -3.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 38).addBox(-4.0F, -7.5F, -3.0F, 8.0F, 18.0F, 6.0F, new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(-5.0F, -4.5F, 8.0F, -0.5236F, 0.0F, 1.5708F));
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(11.0F, 0.0F, 12.0F));
